													...
													<div class="card-body">
														<div class="col-sm-8 float-left">
															...
															<div class="form-group">
															   ...
															   value="{{Auth::guard('instructor')->user()->instr_name}}" required />
															...
															<div class="row">
																<div class="form-group col-sm-6">
																   ...
																   value="{{Auth::guard('instructor')->user()->instr_phone}}" required />
																   <span class="form-text text-muted">Please enter your Phone number</span>
																</div>
																<div class="form-group col-sm-6">
																   <label>Email:</label>
																   <input name="instr_email" type="text" class="form-control form-control-solid" value="{{Auth::guard('instructor')->user()->instr_email}}" required />
