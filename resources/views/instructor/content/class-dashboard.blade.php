								...
								<div class="d-flex flex-column flex-md-row">
									...
									<div class="flex-md-row-auto w-md-275px w-xl-325px">
												...
												<div class="d-flex justify-content-between flex-column h-100">
													...
													<div class="h-100">
														...
														<div class="d-flex flex-column flex-center">
															...
															<!--end::Image-->
															<!--begin::Title-->
															<a href="#" class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">{{$class->cat_title}}</a>
															<!--end::Title-->
														...
														<div class="pt-1">
															...
															<div class="d-flex align-items-center pb-9">
																...
																<div class="d-flex flex-column flex-grow-1">
																	<a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Total Students</a>
																	
																</div>
																<!--end::Text-->
																<!--begin::label-->
																<span class="font-weight-bolder label label-xl label-light-success label-inline px-3 py-5 min-w-45px">332</span>
																<!--end::label-->
															</div>
															<!--end::Item-->
															<!--begin::Item-->
													...
													@foreach ($courses as $course)
														...
														<div class="d-flex align-items-center mb-8">
															...
															<div class="d-flex flex-column">
																...
																<!--begin::Action-->
																<div>
																	<a href=""><button type="button" class="btn btn-light font-weight-bolder font-size-sm py-2">Enter Course</button></a>
																</div>
																<!--end::Action-->
															</div>
															<!--end::Info-->
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">Polls in Marketing Class</span>
										...
										<div class="row">
											...
											<div class="col-xxl-4">
																			...
																			@foreach ($assignments as $assignment)
																				<tr>
																					...
																					<td class="pl-0">
																						...
																						<span class="text-muted font-weight-bold d-block">by {{$assignment->instr_name}}</span>
																					</td>
																					<td></td>
																					<td class="text-left">
												...
												<div class="card card-custom gutter-b">
													...
													<div class="card-header border-0 pt-5">
														<h3 class="card-title align-items-start flex-column">
															<span class="card-label font-weight-bolder text-dark">Quizzes in Marketing Class</span>
															@isset ($quizzes[0])
