						...
						<div class="container">
								...
								<div class="d-flex flex-column flex-md-row">
									...
									<div class="flex-md-row-auto w-md-275px w-xl-325px">
												...
												<div class="d-flex justify-content-between flex-column pt-4 h-100">
													...
													<div class="pb-5">
														...
														<div class="d-flex flex-column flex-center">
															...
															<!--end::Symbol-->
															<!--begin::Username-->
															<a href="#" class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">Ogoluwa Ojewale</a>
															<!--end::Username-->
															<!--begin::Info-->
													...
													<!--eng::Container-->
													<!--begin::Footer-->
													<a href="learner/profile.html" class="d-flex flex-center" id="kt_sticky_toolbar_chat_toggler_1" data-toggle="tooltip" title="" data-placement="right" data-original-title="Edit Profile">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-muted mt-3 font-weight-bold font-size-sm">4 Classes</span>
												</h3>
												...
												<div>
													...
													<div class="d-flex align-items-center mb-8">
														...
														<div class="d-flex flex-column">
															...
															<!--begin::Action-->
															<div>
																<button type="button" class="btn btn-light font-weight-bolder font-size-sm py-2">Enter Class</button>
															</div>
															<!--end::Action-->
														</div>
														<!--end::Info-->
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-header align-items-center border-0 mt-4">
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-muted mt-3 font-weight-bold font-size-sm">300 users</span>
												</h3>
												<div class="card-toolbar">
										...
										<div class="card card-custom gutter-b pt-10 d-none">
										...
										<div class="row">
											...
											<div class="col-xxl-4">
												...
												<div class="card card-custom gutter-b pt-10">
					                                ...
					                                <div id="myCalendarWrapper_one"></div>
					                            </div>
					                            <!--begin::Base Table Widget 10-->
												...
												<div class="card card-custom gutter-b">
													...
													<div class="card-header border-0 pt-5">
														<h3 class="card-title align-items-start flex-column">
															...
															<span class="text-primary">25 minutes</span></span>
														</h3>
													...
													<div class="card-body pt-2 pb-0 mt-n3">
														<div class="tab-content mt-5" id="myTabTables10">
															...
															<div class="tab-pane fade  show active" id="kt_tab_pane_10_1" role="tabpanel" aria-labelledby="kt_tab_pane_10_1">
																	...
																	<table class="table table-borderless table-vertical-center">
																		...
																		<tbody>
																			<tr>
																					...
																					<div class="symbol symbol-45 symbol-light-info mr-2">
																						<span class="symbol-label">
																							<span class="svg-icon text svg-icon-2x svg-icon-info">
																								...
																								<i class=" text-muted fa fas fa-music"></i>
																								<!--end::Svg Icon-->
																							</span>
																						</span>
																					</div>
																				...
																				<td class="pl-0">
																					<a href="#" class=" text-muted text-hover-primary mb-1 font-size-lg">Music</a>
																					<span class="text-muted font-weight-bold d-block">in SS1</span>
																				</td>
																				<td></td>
																				<td class="text-left text-muted">
																					<span class="font-size-lg">9:20 - 10:00PM</span>
																					<span class=" font-weight-bold d-block font-size-sm">Time</span>
																				</td>
																				<td class="text-right pr-0">
																					<a href="#" class="btn btn-icon btn-light btn-sm">
																						<i class=" text-muted fa fas fa-clipboard-check"></i>
																					</a>
																				</td>
																			</tr>
																			<tr>
																...
																<!--end::Table-->
																<div class="d-flex flex-center mb-12" id="kt_sticky_toolbar_chat_toggler_1" data-toggle="tooltip" title="" data-placement="right" data-original-title="Edit Profile">
														...
														<div class="tab-content mt-5" id="myTabTables2">
															...
															<div class="tab-pane fade active show" id="kt_tab_pane_2_3" role="tabpanel" aria-labelledby="kt_tab_pane_2_3">
																...
																<div class="table-responsive">
																	...
																	<a href="learner/courses.html" class="d-flex flex-center mb-12" id="kt_sticky_toolbar_chat_toggler_1" data-toggle="tooltip" title="" data-placement="right" data-original-title="View All Courses">
																		<button class="btn btn-primary font-weight-bolder font-size-sm py-3 px-14" data-toggle="modal" data-target="#kt_chat_modal">View All</button>
																	</a>
																</div>
																<!--end::Table-->
												...
												<div class="card card-custom gutter-b">
													...
													<div class="card-header border-0 pt-5">
														<h3 class="card-title align-items-start flex-column">
															...
															<span class="text-primary">24</span></span>
														</h3>
																	...
																	<table class="table table-borderless table-vertical-center">
																		...
																		<tbody>
																			<tr>
																				...
																				<td class="pl-0">
																					<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Geography Assignment</a>
																					<span class="text-muted font-weight-bold d-block">By Simon Joel</span>
																				</td>
																				<td></td>
																				<td class="text-left">
																					<span class="text-dark-75 font-weight-bolder d-block font-size-lg">03 Sep, 4:20PM</span>
																			...
																			<tr>
																				...
																				<td class="pl-0">
																					<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Music Assignment</a>
																					<span class="text-muted font-weight-bold d-block">by Tom Akan</span>
																				</td>
																				<td></td>
																				<td class="text-left">
																					<span class="text-dark-75 font-weight-bolder d-block font-size-lg">03 Sep, 4:20PM</span>
																			...
																			<tr>
																				...
																				<td class="pl-0">
																					<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Physics Assignment</a>
																					<span class="text-muted font-weight-bold d-block">by Johnson Sam</span>
																				</td>
																				<td></td>
																				<td class="text-left">
																					<span class="text-dark-75 font-weight-bolder d-block font-size-lg">03 Sep, 4:20PM</span>
																			...
																			<tr>
																				...
																				<td class="pl-0">
																					<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">History Assignment</a>
																					<span class="text-muted font-weight-bold d-block">by Luke Evans</span>
																				</td>
																				<td></td>
																				<td class="text-left">
																					<span class="text-dark-75 font-weight-bolder d-block font-size-lg">03 Sep, 4:20PM</span>
																			...
																			<tr>
																				...
																				<td class="pl-0">
																					<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Calculus Lesson</a>
																					<span class="text-muted font-weight-bold d-block">by Tunde Olawale</span>
																				</td>
																				<td></td>
																				<td class="text-left">
																					<span class="text-dark-75 font-weight-bolder d-block font-size-lg">25 Oct, 10:05PM</span>
