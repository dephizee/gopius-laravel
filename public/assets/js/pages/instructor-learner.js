        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            columns: [{
                ...
                template: function(row) {
                    ...
                    return '<span class="label font-weight-bold label-lg ' + status[row.learner_status].class + ' label-inline">' + status[row.learner_status].title + '</span>';
                },
            }, {
                field: 'Actions',
                title: 'Actions',
